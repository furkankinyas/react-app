    ...
    return(
      <header className="background-primary color-white padding-md height-md flex between middle margin-bottom-md">
        ...
        {this.props.activePage!=="/about/"&&
          <input style={searchInput} onChange={e => this.props.changeUsername(e.target.value)} value={this.props.searchText} className="radius-max height-sm padding-md" placeholder="arama" type="text"/>
        }
        </div>
          <nav>
            <ul className="flex">
